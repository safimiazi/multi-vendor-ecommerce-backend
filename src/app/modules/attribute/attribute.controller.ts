import { Request, Response } from "express";
    ...
    const updateAttribute = catchAsync(async (req: Request, res: Response) => {
      const result = await attributeService.updateAttributeIntoDB(req.body);
    ...
    export const attributeController = { postAttribute, getAllAttribute, getSingleAttribute, updateAttribute, deleteAttribute };
