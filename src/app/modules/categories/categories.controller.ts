import { Request, Response } from "express";
    ...
    const getSingleCategories = catchAsync(async (req: Request, res: Response) => {
      const result = await categoriesService.getSingleCategoriesFromDB(req.params.id);
      sendResponse(res, { statusCode: status.OK, success: true, message: "Fetched successfully", data: result });
    });
    ...
    export const categoriesController = { postCategories, getAllCategories, getSingleCategories, updateCategories, deleteCategories };
